      ...
      <div class="col-md-7">
    	...
    	<form name="newBook" action="<%= request.getContextPath() %>/ProcessAddBook" method="post" enctype="multipart/form-data">
    		<div class="mb-3 row">
					...
					<div class="col-sm-3">
						<input type="text" id="bookId" name="bookId" class="form-control" value="<%=bookId%>" readonly>
					</div>
				</div>
				<div class="mb-3 row">
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-5">
						<input type="radio" name="condition" value="New"  <%= "New".equals(condition) ? "checked" : "" %>> 신규도서 
						<input type="radio" name="condition" value="Old"  <%= "Old".equals(condition) ? "checked" : "" %>> 중고도서 
						<input type="radio" name="condition" value="EBook" <%= "Ebook".equals(condition) ? "checked" : "" %>> E-Book
					</div>				
				</div>		
				<div class="mb-3 row">
				...
				<div class="mb-3 row">
					<div class="col-sm-offset-2 col-sm-10">
						<button type="submit" onclick="checkAddBook(event)" class="btn btn-primary">등록</button>
					</div>
				</div>
    	</form>
    	</div>
